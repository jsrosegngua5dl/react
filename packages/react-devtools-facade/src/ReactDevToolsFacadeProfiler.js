...
import type {RendererInternals, ProfilingState} from './ReactDevToolsFacade';
import type {ToolError} from './ReactDevToolsFacadeTree';

import {getTypeTag} from './ReactDevToolsFacadeTree';
 ...
 * getTreeSnapshot/getComponentByLabel). The hook installed by installFacade
